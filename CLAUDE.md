...
github.com/RiftCompass/RiftCompass-Tauri) — esos comentarios son la
...
(el repo ya vive en `RiftCompass/RiftCompass-Electron`), para que quien ya
...
- [x] Bloque `publish` (`provider: github`, owner `RiftCompass`, repo
...
- [x] **`DownloadAppButton` reactivado en la web (2026-09-01)**: era un
      ...
      `github.com/RiftCompass/RiftCompass-Electron/releases/download/v0.1.0/RiftCompass-Setup-0.1.0.exe`,
...
- [x] **Primer Release real publicado**: `v0.1.0`
      (github.com/RiftCompass/RiftCompass-Electron/releases/tag/v0.1.0),
