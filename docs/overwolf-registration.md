...
(login con Google, `correo-personal@gmail.com`) y the tooling rellenó y
...
Overwolf) — the tooling puede ayudar a redactar/rellenar la descripción de la
...
## Notas para cuando retome esto the tooling (tras la aprobación)
...
- **La migración a Electron ya está en marcha, no es solo un plan**: ver
  ...
  intacta) y su propio `the project guide` para arquitectura y estado. El puerto
